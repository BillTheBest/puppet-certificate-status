...
describe "Puppet::SSL::CertificateStatus::File" do
  before do
    Puppet::SSL::CertificateAuthority.stubs(:ca?).returns true
    @terminus = Puppet::SSL::CertificateStatus.indirection.terminus(:file)
  ...
  it "should be a terminus on CertificateStatus" do
    @terminus.should be_instance_of(Puppet::SSL::CertificateStatus::File)
  end
  ...
  it "should be indirected with the name 'certificate_status'" do
    Puppet::SSL::CertificateStatus.indirection.name.should == :certificate_status
  end

  describe "when saving" do
    before do
      @signer = Puppet::SSL::CertificateStatus.new("mysigner")
      @request = Puppet::Indirector::Request.new(:certificate_status, :save, "mysigner", @signer)
      @csr = mk_csr("mysigner")
